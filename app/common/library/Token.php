...
class Token
{
     ...
     * @return object
     */
    public function getDriver(string|null $name = null): object
    {
     ...
     * @return array|string
     */
    protected function getConfig(string|null $name = null, $default = null): array|string
    {
        if (!is_null($name)) {
            return Config::get('badouadmin.token.' . $name, $default);
        }

        return Config::get('badouadmin.token');
    }
     ...
     * @return array|string
     */
    protected function getStoreConfig(string $store, string|null $name = null, $default = null): array|string
    {
     ...
     * @return bool
     */
    public function set(string $token, string $type, int $user_id, int|null $expire = null): bool
    {
