layui.define(['table', 'laypage', 'jquery', 'element', 'laytpl'], function (exports) {
	...
	function createCards(elem, linenum, data) {
		var content = "<div class='layui-row layui-col-space30' style='margin-top:0;margin-bottom:0;'>";
