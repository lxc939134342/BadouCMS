...
-- ----------------------------
BEGIN;
INSERT INTO `bd_admin` (`id`, `username`, `nickname`, `avatar`, `email`, `mobile`, `login_failure`, `last_login_time`, `last_login_ip`, `password`, `salt`, `motto`, `status`, `update_time`, `create_time`) VALUES (1, 'admin', 'Admin', '', 'admin@buildadmin.com', '18888888888', 0, 1734255169, '127.0.0.1', '2d960f5f826c8729555e4e85b0b072b3', 'HDcnBjOyFdgTluk1', '', '1', 1734255169, 1722731863);
COMMIT;
...
CREATE TABLE `bd_admin_log` (
  ...
  `create_time` bigint(16) unsigned DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7040 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='管理员日志表';
...
CREATE TABLE `bd_admin_rule` (
  ...
  PRIMARY KEY (`id`),
  KEY `pid` (`pid`)
) ENGINE=InnoDB AUTO_INCREMENT=505 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='菜单和权限规则表';
...
-- ----------------------------
BEGIN;
INSERT INTO `bd_captcha` (`key`, `code`, `captcha`, `create_time`, `expire_time`) VALUES ('1b88ab45d0f3155a49cce08dafbc9ebc', 'b1c6947e84cef1b1622d9dfe484453e2', '8725', 1734254398, 1734254998);
INSERT INTO `bd_captcha` (`key`, `code`, `captcha`, `create_time`, `expire_time`) VALUES ('203376c6530909a44fe720d9a5f11be3', '7a78b4d103f2969d5db5cbf63b6b3f83', '6884', 1734254398, 1734254998);
COMMIT;
