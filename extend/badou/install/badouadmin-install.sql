...
INSERT INTO `bd_admin_rule` (`id`, `type`, `pid`, `name`, `title`, `icon`, `url`, `condition`, `remark`, `ismenu`, `menutype`, `extend`, `py`, `pinyin`, `create_time`, `update_time`, `weigh`, `status`) VALUES (2, '1', 1, 'dashboard/index', 'index', 'fa fa-circle-o', '', '', '', 0, NULL, '', '', '', 1750995040, 1750995040, 0, 'normal');
...
INSERT INTO `bd_admin_rule` (`id`, `type`, `pid`, `name`, `title`, `icon`, `url`, `condition`, `remark`, `ismenu`, `menutype`, `extend`, `py`, `pinyin`, `create_time`, `update_time`, `weigh`, `status`) VALUES (279, '0', 0, 'general', '常规设置', 'layui-icon layui-icon-set', '', '', '', 1, '_iframe', '', '', '', 1750995040, 1751626087, 99998, 'normal');
INSERT INTO `bd_admin_rule` (`id`, `type`, `pid`, `name`, `title`, `icon`, `url`, `condition`, `remark`, `ismenu`, `menutype`, `extend`, `py`, `pinyin`, `create_time`, `update_time`, `weigh`, `status`) VALUES (280, '1', 279, 'general.config', '系统设置', 'layui-icon layui-icon-set', '', '', '', 1, NULL, '', '', '', 1750995040, 1751893428, 0, 'normal');
...
INSERT INTO `bd_admin_rule` (`id`, `type`, `pid`, `name`, `title`, `icon`, `url`, `condition`, `remark`, `ismenu`, `menutype`, `extend`, `py`, `pinyin`, `create_time`, `update_time`, `weigh`, `status`) VALUES (998, '1', 279, 'database', '数据库管理', '', '', '', '', 1, '_iframe', '', '', '', 1752370539, 1752370539, 0, 'normal');
INSERT INTO `bd_admin_rule` (`id`, `type`, `pid`, `name`, `title`, `icon`, `url`, `condition`, `remark`, `ismenu`, `menutype`, `extend`, `py`, `pinyin`, `create_time`, `update_time`, `weigh`, `status`) VALUES (999, '2', 998, 'database/index', '查看', '', '', '', '', 0, '_iframe', '', '', '', 1752552921, 1752552921, 0, 'normal');
INSERT INTO `bd_admin_rule` (`id`, `type`, `pid`, `name`, `title`, `icon`, `url`, `condition`, `remark`, `ismenu`, `menutype`, `extend`, `py`, `pinyin`, `create_time`, `update_time`, `weigh`, `status`) VALUES (1000, '2', 998, 'database/backuplist', '备份/还原', '', '', '', '', 0, '_iframe', '', '', '', 1752552979, 1752552979, 0, 'normal');
INSERT INTO `bd_admin_rule` (`id`, `type`, `pid`, `name`, `title`, `icon`, `url`, `condition`, `remark`, `ismenu`, `menutype`, `extend`, `py`, `pinyin`, `create_time`, `update_time`, `weigh`, `status`) VALUES (1001, '2', 998, 'database/backup', '备份', '', '', '', '', 0, '_iframe', '', '', '', 1752553006, 1752553006, 0, 'normal');
INSERT INTO `bd_admin_rule` (`id`, `type`, `pid`, `name`, `title`, `icon`, `url`, `condition`, `remark`, `ismenu`, `menutype`, `extend`, `py`, `pinyin`, `create_time`, `update_time`, `weigh`, `status`) VALUES (1002, '2', 998, 'database/backupdel', '删除备份', '', '', '', '', 0, '_iframe', '', '', '', 1752553029, 1752553029, 0, 'normal');
INSERT INTO `bd_admin_rule` (`id`, `type`, `pid`, `name`, `title`, `icon`, `url`, `condition`, `remark`, `ismenu`, `menutype`, `extend`, `py`, `pinyin`, `create_time`, `update_time`, `weigh`, `status`) VALUES (1003, '2', 998, 'database/restore', '恢复', '', '', '', '', 0, '_iframe', '', '', '', 1752553058, 1752553058, 0, 'normal');
INSERT INTO `bd_admin_rule` (`id`, `type`, `pid`, `name`, `title`, `icon`, `url`, `condition`, `remark`, `ismenu`, `menutype`, `extend`, `py`, `pinyin`, `create_time`, `update_time`, `weigh`, `status`) VALUES (1004, '2', 998, 'database/optimize', '优化表', '', '', '', '', 0, '_iframe', '', '', '', 1752553086, 1752553086, 0, 'normal');
INSERT INTO `bd_admin_rule` (`id`, `type`, `pid`, `name`, `title`, `icon`, `url`, `condition`, `remark`, `ismenu`, `menutype`, `extend`, `py`, `pinyin`, `create_time`, `update_time`, `weigh`, `status`) VALUES (1005, '2', 998, 'database/repair', '修复表', '', '', '', '', 0, '_iframe', '', '', '', 1752553110, 1752553110, 0, 'normal');
COMMIT;
