<template>
    <div class="nav-menus" :class="configStore.layout.layoutMode">
        ...
        <!-- 站点主页 -->
        <a :href="homeUrl" class="h100" target="_blank">
            <div class="nav-menu-item">
                <Icon :color="configStore.getColorVal('headerBarTabColor')" class="nav-menu-icon" name="el-icon-Monitor" size="18" />
            </div>
        </a>
        <!-- 版本 - 仅超管 -->
        <div v-if="adminInfo.super" @click="handleUpgrade" class="nav-menu-item pt2" style="width: 70px">
            <el-badge :isDot="badoucms.isUpdate">
                <el-tag type="warning" round>V{{ badoucms.version }}</el-tag>
            </el-badge>
        </div>
        <!-- 语言切换 -->
        <el-dropdown
...
import UpgradeVue from '/@/components/upgrade/index.vue'
